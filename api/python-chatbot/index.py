...
async def chat_handler(request: ChatRequest, response: Response):
    try:
        ...
        1.  **Yeni Konu Talebi:** Eğer öğrenci yeni bir konu istiyorsa VE sana bu konuyla ilgili bir "KAYNAK METİN" verildiyse, o metni kullanarak konuyu basitçe anlat.
            (KAYNAK METİN: "{knowledge_text if knowledge_text else 'Yok'}")
